...
from .views import UserProfileCreateAPIView, LoginAPIView, OtpVerificationAPIView, KYCPanAPIView, KYCImageAPIView, PhoneNumbrAPIView, PasswordAPIView, AddressAPIView, FetchBankDetailsAPIView, WithdrawAPIView, DepositAPIView, TotalAPIView
